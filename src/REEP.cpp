...
Grafo REEP::ObterArvore() const
{
    return T;
}

vector<int> REEP::ObterBranches() const
{
    return BT;
}

vector<int> REEP::ObterGrauBT() const
{
    vector<int> GrauBT;
    for (int v : BT)
    {
...
//Algoritmo Árvore Geradora - Terceira Heurística Randomizada
void REEP::Oliveira()
{
    BT.clear();
